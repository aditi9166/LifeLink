...
Original file is located at
    https://colab.research.google.com/drive/1TIF24l2hSjsjHvipQrukHMXco7gM6Bge
"""

!pip install streamlit folium streamlit-folium geopy requests python-dotenv pyngrok
